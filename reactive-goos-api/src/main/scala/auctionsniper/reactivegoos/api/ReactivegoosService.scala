package auctionsniper.reactivegoos.api
...
object ReactivegoosService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The reactive-goos service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ReactivegoosService.
  */
trait ReactivegoosService extends Service {
  ...
  override final def descriptor = {
    ...
    named("reactive-goos")
      ...
      .withTopics(
        topic(ReactivegoosService.TOPIC_NAME, greetingsTopic)
